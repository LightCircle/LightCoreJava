...
public class Generator {
    ...
    private TypeSpec.Builder mainClass(String className, Integer type) {
        return TypeSpec.classBuilder(Constant.MODEL_PREFIX + WordUtils.capitalize(className))
                ...
                .superclass(structureType.get(type))
    ...
    private final static List<TypeName> structureType = Arrays.asList(
            TypeName.get(ModCommon.class),
            TypeName.get(ModUser.class),
            TypeName.get(ModGroup.class),
            TypeName.get(ModCategory.class),
            TypeName.get(ModFile.class)
    );
