...
public class Constant {
    ...
    public static final String ENV_LIGHT_APP_LOCAL = "LOCAL";
    public static final String ENV_LIGHT_APP_DEV = "DEV";
    ...
    public static final long STRUCT_KIND_MYSQL_SYSTEM = 6;        // RDB 系统表
}
