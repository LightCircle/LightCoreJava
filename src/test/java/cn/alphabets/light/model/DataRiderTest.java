...
//
////
////        ModUser user22 = DataRider.ride(ModUser.class).add(new DBParams());
////        Plural<ModUser> user33 = DataRider.ride(ModUser.class).list(new DBParams());
////        Plural<ModUser> user44 = DataRider.ride(ModUser.class,"list_test").list(new DBParams());
//    }
//
//    @Test
